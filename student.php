...
// $sql= "insert into student_tbl('name','class','roll_no','grade','mob_no','gender','country')
// values($name,$class,$roll_no,$grade,$mob_no,'$gender','$country')";
...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO student_tbl (name, class, roll_no, grade, mob_no, gender, email,country)
            VALUES (?, ?, ?, ?, ?, ?, ?,?)";
    ...
    // Bind parameters
    // mysqli_stmt_bind_param($stmt, "", $name, $class, $roll_no, $grade, $mob_no, $gender, $email ,$country);
    mysqli_stmt_bind_param($stmt, "ssssssss", $name, $class, $roll_no, $grade, $mob_no, $gender, $email ,$country);
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mob_no" name="mob_no" required autocomplete="off">
                    </div>
